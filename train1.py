...
validation_data_dir = 'datas/validation'
test_data_dir = 'datas/test'
...
train_datagen = ImageDataGenerator(
    ...
    shear_range=0.2,
    zoom_range=0.2,
    horizontal_flip=True,contrast_stretching=False, adaptive_equalization=False, histogram_equalization=False)
...
model.save_weights('final_main_train_1.h5')
model.save('final_main_train_1.json')
